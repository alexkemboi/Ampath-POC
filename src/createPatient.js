...
function CreatePatient() {
  ...
  const handleSubmit = async(e) => {
    ...
    if (givenName !== "" && familyName !== "" && gender !== "" && city !== "" && postalcode !== ""
      ...
      try {
          const result= await axios(`http://10.50.80.115:8090/amrs/ws/rest/v1/person`, {
            method: "POST",
            headers: {
      ...
      alert("Kindly all filleds are required");
        ...
        const create_patient =async(e)=>{
          ...
          let patientData = JSON.stringify({
            ...
            try{
              await axios(`http://10.50.80.115:8090/amrs/ws/rest/v1/patient`, {
               method: "POST",
               headers: {
                 "Content-Type": "application/json",
                 Authorization: `Basic ${session_id}`
  ...
  return (
    <div className="divcreate1">
      ...
      <div className="ttl">
         <span>< TextInput labelText="GivenName"
            name="givenName"
            id="giveName"
